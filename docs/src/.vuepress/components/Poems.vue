<template>
  <div
    ...
    "
  >
    <h1 class="text-red-400 font-bold mt-40 text-center text-6xl">Poems</h1>
    <div class="mt-4 grid grid-cols-1 gap-14 max-w-5xl xs:grid-cols-2">
      <a href="/artist">
        <button class="w-80 h-72  hover:bg-blue-200 rounded-full">
          <img src="/images/artist_1.png" /></button
      ></a>
      <a href="/titanic">
        <button class="w-80 h-72 hover:bg-blue-200 rounded-full">
          <img src="/images/titanic_1.png" /></button
      ></a>
      <a href="/blaze">
        <button class="w-80 h-72 hover:bg-blue-200 rounded-full">
          <img src="/images/blaze_1.png" /></button
      ></a>
      <a href="/chainofyouth">
        <button class="w-80 h-72 hover:bg-blue-200 rounded-full">
          <img src="/images/chains_of_youth_1.png" /></button
      ></a>
      <a href="/bathsheba">
        <button class="w-80 h-72 hover:bg-blue-200 rounded-full">
