<template>
  <div class="bg-scroll bg-main2 bg-center bg-cover h-screen overflow-auto">
    ...
    <div
      ...
      "
    >
      <div class="mb-8 ml-0 pt-24 xs:ml-56">
        <div class="text-gray-900 font-bold text-2xl mb-2 ml-0 xs:mr-60 xs:ml-16 xs:text-4xl">
          Penelope Cloverfield and the Tale of the Predictable Prophecy
          <br />
          <br />
          <span class="italic text-red-400 text-1xl ml-0 xs:text-2xl">By: Kayla Lare</span>
          <br />
        </div>
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          mother had taught us, like a proper young lady.
        </p>
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">Well then.</p>

        <p class="text-red-400 font-bold text-center text-2xl p-4 xs:ml-0 xs:mr-56 xs:text-3xl">***</p>
        
        <p class="xs:ml-0 xs:mr-56 xs:text-2xl">
          Milking cows is a dreary affair. Achilles (Mom let me name her) was
          the only cow we owned and she had a crooked heel (Ha! get it?) that
          often made the act of merely standing still a very tiresome effort for
          her. Thus, in order to get milk, I had to position Achilles in a way
          that allowed for me to crawl underneath her and properly tug at her
          utters. It usually ended up with me flat on my back with the milk
          bucket on my chest, at the complete mercy of the cow, who could simply
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          rooms and a garden. We had a hen named Mrs. Featherhead (Arabella got
          to name her) and she often ran around the property, squawking like a
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          >
          Emi had a mischievous look on his face, the kind he usually got when
          we were mocking royalty or our overbearing parents.
          <span class="italic text-black"
            >“Heard he was here to enlighten the masses. To-”</span
          >
          Emi put on a ridiculously pretentious accent, one you might hear from
          a noble or a prince. >“Shine light on the pathways that may lead us to
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          fate through premonitions and oracles. Take a look at the Bible, I
          know you’ve read that one. It tells of so many prophets and preachers
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          <span class="italic text-black"
            ...
            do speak of the future, but I do not like them. A prophecy ruins the
            ending of our stories. They give us the truth that we were meant to
            unravel for ourselves. A good story keeps us guessing, surprises and
            surpasses our expectations. I do not like prophecies because I do
            not want to be told how to write my own story.”</span
          >
        </p>
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          plastered on my face and the distinct sound of coins jingling in my
          pocket, I must seem like the perfect target to steal from. I try to
          mimic the expression I’ve seen Mom make when I’ve forgotten to get the
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          <span class="italic text-black"
            >“Do you wish for knowledge of the future?”
          </span>
        </p>
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          after my father died and the crown came to take his possessions, I hid
          the books under my pillow. That Mom is still unaware that I’ve kept
          them to this day. That sometimes I’ll take a coin or two from our
          earnings and ask the local bookkeeper to recite a passage or two from
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl italic">
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          top. Mom gave us the day off from chores. Arabella was going to be so
          pleased.
        </p>
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          conjured up on my way to his stand. People had gathered around to
          listen to me recite a tale of epic adventure and tragic love. They
          asked me where I had read this story and I told them that it was me
          who had come up with it. The crowd was back at Emi’s stand the next
          day, a couple more villagers having joined them. It became like that
          everyday, the crowd growing larger and coins beginning to drop into
          the pockets of my dress. Mom was so pleased she no longer insisted
          that I be married off immediately. I had gotten quite old. Most
          sixteen year olds are bearing their fourth child by now. I didn’t
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          insistence to braid Arabella’s hair into neat dark plaits, we headed
          out to the village, Mom accompanying us. We found Emi waiting by his
          stand as usual. He waved at us. I smiled. I did that a lot when he was
          around.
        </p>
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          girl. “Make sure you don’t share that with anyone else. You’re
          supposed to be selfish on your birthday.” He winked and stood back up.
          Arabella gave me a look as if to say when are you going to put a ring
          on him? Then she scurried off, joining her friend Orla, whose mother
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          if to tell them that they shouldn’t be scared of the dirty people that
          were beginning to gather around them. He then opened the carriage door
          and two soldiers got out followed by a stubby looking man and...oh
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          or a member of his family. How could I possibly act nonchalant when I
          knew the ending of this story. When I knew that this tale was a
          tragedy.
        </p>
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          simply observe my craft.” I curtsy to both the Prince and the Royal
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          bed thinking about the royal visit. I wanted her to go to bed dreaming
          of the legend I was about to tell. The legend that was made for her
          specifically. No Prince would get in the way of this. My nerves
          disappeared as I gazed at the crowd watching me expectantly. I was
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          ivory castle and the princess made of glass. Caught up in her tragic
          curse, never able to touch or be touched. Caught up in her isolation,
          her sorrow, her one hope that leads to a terrifying adventure. I am
          faintly aware of the tears from my audience. They turn to smiles and
          back again to tears. I hear laughs and I hear gasps. It fuels the
          princess made of glass. Makes her story continue to unravel out of me
          until I’m not sure it’s my story anymore. It becomes lifelike, it’s
          own entity. By the time the story reaches the fatal words The End, my
          voice is hoarse and my eyes are closed. I blinked them open to observe
          my listeners. They were all staring at me, transfixed, obviously still
          trapped in the other world. My other world. I wait patiently as
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          drifted from me to the Prince, bowing and politely offering their
          thanks to him as well. It was weird that they were coming to me before
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          had come to join us, followed by Arabella, Orla, and Orla’s mother.
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl italic">
          ...
          possibly result in the destruction I’d been told about? But what if it
          was my selfish action of staying that resulted in the prophecies'
          fulfillment? I turned these thoughts over in my brain, almost certain
          that I would go mad before I could even give the king a response. The
          long silence began to purse lips as everyone wondered why I had yet to
          speak a word.
        </p>
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl italic">
          ...
          and I got to give our godforsaken farm animals to Emi. No more
          listening to shrieking chickens or milking unsteady cows. It was all I
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl italic">
          ...
          decision would fulfil the prophecy. Had I made it already? The entire
          thing was driving me positively mad. Maybe it turns out that little
          Princess Rosie is deathly allergic to the tulips I had decided to pick
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl italic">
          ...
          interactions go something like this. He sees me and calls out my name.
          I immediately panic and pray that I won’t accidently slaughter him in
          the next five minutes of conversation. He asks me why I’m acting so
          odd. I tell him I’m tired and then make a feeble excuse about going to
          lie down.
        </p>
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl italic">
          ...
          would be prepared. That was the problem with prophecies. They had the
          audacity to spoil the ending of stories but didn’t even have the
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl italic">
          ...
          tragedy occurring in such a beautiful place. Beauty and tragedy often
          come hand in hand. It was what made the most alluring stories. What
          made people weep.
        </p>
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl italic">
          ...
          letter. She was very disappointed, but I have a feeling you will not
          be.”
        </p>
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl italic">
          ...
          drawn, as if the sender’s hand wasn’t used to writing. There was a
          blot of ink that smudged the r in Princess. I pulled the letter out
          carefully.
        </p>

        <p class="text-gray-600 text-2xl p-4 mr-8 ml-8 text-left font-letter text-1xl xs:ml-16 xs:mr-64 xs:text-2xl">
          DEAREST PENELOPE,
        </p>

        <p class="text-gray-600 text-2xl p-4 mr-8 ml-8 text-left font-letter text-1xl xs:ml-16 xs:mr-64 xs:text-2xl">
          IT IS WITH THE UTMOST UNCERTAINTY THAT I WRITE TO YOU. IT IS BECAUSE
          OF THIS UNCERTAINTY THAT I KNOW THIS LETTER MUST BE SENT. IT”S BEEN A
          YEAR SINCE I”VE SEEN YOU. IT WOULD BE THE WORST OF MY LIFE IF I DID
          NOT KNOW HOW YOU’VE BEEN SPENDING IT. I KNOW NOTHING BUT BLISS WHEN I
          THINK OF YOU FINALLY FULFILLING YOUR BIRTHRIGHT. YOU WERE BORN TO TELL
          STORIES, THAT MUCH I KNOW TO BE TRUE.
        </p>

        <p class="text-gray-600 text-2xl p-4 mr-8 ml-8 text-left font-letter text-1xl xs:ml-16 xs:mr-64 xs:text-2xl">
          ALTHOUGH I FIND MYSELF REJOICING AT YOUR GOOD FORTUNE I CAN’T HELP BUT
          NOTICE HOW MUCH LONELIER THE VILLAGE IS WITHOUT YOUR STRAWBERRY
          PARSELS AND CONSTANT CONVERSATION. I STILL HAVE MY FAMILY, STILL SHARE
          A DRINK WITH SOME OF THE TOWN FOLK, BUT IT HAS BECOME APPARENT THAT
          LONELINESS HAS REPLACED YOU AS MY CLOSEST COMPANION. IN THE SHORTEST
          FORM OF WORDS, I MISS YOU DEARLY.
        </p>

        <p class="text-gray-600 text-2xl p-4 mr-8 ml-8 text-left font-letter text-1xl xs:ml-16 xs:mr-64 xs:text-2xl">
          THIS IS NOT A LETTER BEGGING YOU TO COME BACK. IN FACT, IF YOU LEAVE
          THAT PALACE FOR ME I WILL THROW YOU OVER MY SHOULDER AND DELIVER YOU
          BACK TO THE ROYAL FAMILY MYSELF. THIS LETTER WAS CRAFTED ONLY OUT OF
          LATE REALIZATIONS AND MY ALLCONSUMING CURIOSITY. MY FATHER TELLS ME
          THAT I MUST FIND A WIFE. IT IS TIME FOR ME TO START MY OWN FAMILY HE
          SAYS. I MUST SAY THAT I DON’T DISAGREE. I WANT MY OWN FAMILY. MY OWN
          HOUSE, MY OWN ANIMALS, MY OWN GARDEN. I’VE WANTED ALL OF THESE THINGS
          FOR A LONG TIME, BUT ONLY RECENTLY, AS I’VE BEGUN TO SEARCH FOR A
          POTENTIAL PARTNER, HAVE I REALIZED THAT I ONLY WANT ALL OF THESE
          THINGS WITH YOU.
        </p>

        <p class="text-gray-600 text-2xl p-4 mr-8 ml-8 text-left font-letter text-1xl xs:ml-16 xs:mr-64 xs:text-2xl">
          I KNOW THAT STORY-TELLING WILL ALWAYS BE THE RULER OF YOUR HEART. I
          KNOW THAT YOU WILL NEVER FEEL SUCH PASSION AS WHEN YOU ARE LOST IN
          YOUR OWN IMAGINATION. I DON’T WISH FOR THAT TO CHANGE. YOUR STORIES
          ARE WHO YOU ARE AND YOU WILL NEVER BE ANYTHING LESS. I SIMPLY WISH TO
          KNOW IF THAT WONDERFUL IMAGINATION EVER IMAGINED A FUTURE WITH ME IN
          IT. IF IT IS TRUE THAT YOU’VE FELT EVEN A FRACTION OF THE PASSION YOU
          FEEL FOR YOUR STORIES, FOR ME, THAT WOULD BE ENOUGH. I KNOW THAT YOU
          WERE BORN TO BE A STORYTELLER AND YOU SHALL NEVER STOP, AND ALTHOUGH
          ADMITTEDLY TOO LATE, I’VE COME TO KNOW THAT I WAS BORN TO LOVE YOU AND
          SIMILARLY, I SHALL NEVER STOP.
        </p>
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          two great romances. It was a concept I’ve played with before, putting
          my heroes through agony and missed chances. It was all very enjoyable
          when it wasn’t happening to you. Perhaps I owed a personal apology to
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          expression he continued quickly. “Of course I delivered it to you
          immediately after I figured out who it was for, I’m so sorry if you
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          Madam Cloverfield.” He sounded cautious, as if expecting me to jump to
          my feet and deny it. “I see the look on your face as you wander these
          halls day after day. You smile when you are with your sister and you
          smile when you are telling stories, but alone you look so burdened.
          Watching you read this letter was the first time I’ve seen a semblance
          of happiness in your face since you’ve arrived. I wish for my friends
          to be happy, and if I have some power in making that happen, then I
          will.”
        </p>
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          but what had absolutely wrecked me was the thought of destroying a
          life, especially one from a family who had shown me nothing but
          continuous kindness.
        </p>
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          employment nearer to the castle. You can be together and still
          continue your storytelling. It will all work out. I can make this all
          work out.”
        </p>
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          miss their generosity and their kindness. I would miss the beauty of
          watching Arabella outshine every marble pillar and gold cabinet she
          passed. I would miss the friendship I found in the Prince. Still, this
          only motivated me not to go back. Perhaps I could not prevent a
          prophecy, but I hoped to prolong it. I hoped that maybe fate would
          grow impatient and decide on another way to tell my story. Mom never
          knew of the prophecy, nor would she ever believe it. She grew old and
          tired, and on her deathbed she had yet to forgive me for taking away
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          week and I always found myself calling upon her when I had a free day.
          Those didn’t come often though, not after I became acquainted with
          motherhood.
        </p>
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          him that I wouldn’t be able to take those chances if I was locked up
          in a royal prison. Instead I told him that I didn’t want to miss the
          chance of being his wife, of having children. It was the truth,
          although not all of it, and for years I lived happily, completely in
          love with Emi and our children. It was a practical life, a good one,
          where daydreaming was replaced with reality, because when you have
          three sons, all your focus must be in the real world. My name wasn’t
          on the front of books and the whispers of my legends had faded. I
        ...
        <p class="text-gray-900 text-1xl p-4 text-left xs:ml-0 xs:mr-56 xs:text-2xl">
          ...
          the world, that I realized. Not until I pulled out the letter Emi had
