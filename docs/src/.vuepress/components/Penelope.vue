<template>
  <div class="bg-scroll bg-main2 bg-center bg-cover h-screen overflow-auto">
    <div
      ...
      "
    >
      <div class="pt-24 grid grid-cols-1 ">
        <div
          class="text-gray-900 font-bold text-2xl mb-2 sm:mr-60 sm:ml-16 sm:text-4xl"
        >
          Penelope Cloverfield and the Tale of the Predictable Prophecy
          <br />
          <br />
          <span class="italic text-red-400 text-1xl ml-0 mr-0 sm:text-2xl"
            >By: Kayla Lare</span
          >
          <br />
        </div>
        <p
          class="text-gray-900 text-1xl p-4 text-center ml-0 mr-0 sm:ml-10 sm:mr-56 sm:text-2xl"
        >
        ...
        <p
          class="text-red-400 font-bold text-center text-2xl p-4 sm:ml-0 sm:mr-56 sm:text-3xl"
        >
          ***
        </p>

        <p
          class="text-gray-900 text-1xl p-4 text-center ml-56 sm:ml-10 sm:mr-56 sm:text-2xl"
        >
        ...
        >
          ...
          <br />
          <br />
          "Gifts don’t come at a price.” Emi grinned. I noticed that he didn’t
        ...
        <p
          class="text-gray-600 text-2xl p-4 mr-8 ml-8 text-left font-letter text-1xl sm:ml-16 sm:mr-64 sm:text-2xl"
        >
          DEAREST PENELOPE,
        </p>
